...
You are free to use, modify, fork, and redistribute this project, including commercially. In return, attribution is required: if you distribute this project or a derivative of it, you must include a readable copy of the attribution notices from [`NOTICE`](NOTICE) — which credit Andrew Johnson (RobotX Workshops) as the original author and link back to <https://github.com/RobotX-Workshops/foxglove-params> — in one of the locations permitted by section 4(d) of the License: a `NOTICE` file shipped with your derivative, your source or documentation, or a display generated by your derivative. Any files you modify must also carry prominent notices stating that you changed them (section 4(b)). See section 4 of the License for the exact terms.
